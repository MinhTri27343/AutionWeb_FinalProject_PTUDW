...
export default function ProductCard({
  ...
  return (
    <div
      className={`relative border border-red-500 rounded-lg shadow-md hover:shadow-2xl`}
    >
      ...
      <div className="group relative w-full h-fit pb-3 rounded-lg border-2 border-gray-200 bg-white  hover:border-blue-500 transition-all duration-200 select-none">
        <Image
